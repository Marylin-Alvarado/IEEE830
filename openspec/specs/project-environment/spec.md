...
This capability defines the documented runtime environment specification for the SGR system, including Python version, environment variables for local AI models (Ollama, LlamaCpp, Whisper), project folder structure, and a pinned dependency manifest (`requirements.txt`) for reproducible installations.
