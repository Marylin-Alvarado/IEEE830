...
Define the capabilities for transcribing stakeholder interview audio recordings into text using a local OpenAI Whisper model for requirement elicitation.
