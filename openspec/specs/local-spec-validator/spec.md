...
This capability provides a local Python script for pre-validation of OpenSpec spec file metadata and section completeness, enabling faster feedback during thesis development before committing to the repository.
...
- **THEN** it SHALL print a summary with counters and details of each failure
